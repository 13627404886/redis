...
public class CloneFactory {
    ...
    public static OnSale copy(OnSale target, OnSaleEntity source){
        target = OnSale.builder().id(source.getId()).price(source.getPrice()).beginTime(source.getBeginTime())
